<template>
  <div class="sendDealInfo">
    ...
    <div class="sendDealInfoTitle">
      ...
      <ul class="titleRight">
        <li @click="agreeDealStopBtn(index)" v-if="reveal.dealState[2]&&data.dealInfo.ifConfirmStop" class="cancel">
          终止
        </li>
  ...
  export default {
    ...
    methods:{
      ...
      keepFirstPartyComment(){//保存甲方评价修改后的数据
        Vue.set(this.data.dealInfo.dealevainfoNew,"star",this.starSelected.star)
        Vue.set(this.data.dealInfo.dealevainfoNew,"comment",this.starSelected.text)
